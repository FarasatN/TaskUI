...
public class FourthCardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fourth_card_fragment, container, false);
        mRecyclerView = v.findViewById(R.id.fourth_recycler);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mListModel.add(new TabModel("Fourth Card Data", android.R.drawable.ic_media_play));
        mListModel.add(new TabModel("Fourth Card Data", android.R.drawable.ic_media_play));
        mListModel.add(new TabModel("Fourth Card Data", android.R.drawable.ic_media_play));
        mListModel.add(new TabModel("Fourth Card Data", android.R.drawable.ic_media_play));
        mListModel.add(new TabModel("Fourth Card Data", android.R.drawable.ic_media_play));
